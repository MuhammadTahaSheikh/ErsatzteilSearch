    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <header className="mb-10 text-center">
        ...
        <p className="mx-auto max-w-xl text-slate-600">
          Search spare parts and accessories. Results update as you type.
        </p>
        <p className="mx-auto mt-2 max-w-xl text-sm text-slate-500">
          Test API keywords: <strong>SONY</strong>, <strong>AEG</strong>, <strong>HDMI</strong>
        </p>
      </header>
      ...
      {hint && (
        <div className="mx-auto mb-4 max-w-xl rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-center text-sm text-amber-900">
          {hint}
        </div>
      )}
      ...
      {showNoResults && (
        <div className="rounded-xl border border-dashed border-slate-200 bg-white py-16 text-center">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Try one of the test keywords: SONY, AEG, or HDMI
          </p>
        </div>
      )}
